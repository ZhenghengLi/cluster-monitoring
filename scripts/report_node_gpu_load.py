...
parser.add_argument("--url", dest="url", type=str, default='http://localhost:3000/node-gpu-load')
args = parser.parse_args()

script_path = "/home/mark/GitHub/cluster-monitoring/scripts/collect_node_gpu_load.py"
